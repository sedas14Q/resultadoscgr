...
(function () {
  ...
  async function editarActa(card) {
    ...
    */
    ...
    window.location.href = `/cgo/acta/${actaId}/editar`;
  }
  ...
  async function verificarActualizacion() {
    ...
    */
    try {
      const res = await fetch("/api/cgo/actas/estado", {
        method: "GET",
